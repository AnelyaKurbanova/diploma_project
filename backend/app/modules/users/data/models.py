...
class UserNotificationModel(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_user_notifications_user_id_is_read", "user_id", "is_read"),
        Index("ix_user_notifications_actor_user_id", "actor_user_id"),
    )
    ...
    read_at: Mapped[object | None] = mapped_column(
        DateTime(timezone=True),
        nullable=True,
    )
    created_at: Mapped[object] = mapped_column(
